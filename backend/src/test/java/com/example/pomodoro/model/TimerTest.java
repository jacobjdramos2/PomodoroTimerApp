...
//         assertEquals(0, timer.getState(), "Start time should be 0");
...
//         timer.start();
//         timer.updateTime(10);  // simulate 10 seconds elapsed
//         timer.reset();
//         assertEquals(0, timer.getState(), "Status should reset to 0");
...
//         timer.start();
//         timer.updateTime(10); // simulate 10 seconds elapsed
//         assertEquals(10, timer.getState(), "Status should be updated to 10");
...
//         timer.start();
//         timer.stop();
//         assertEquals(0, timer.getState(), "Status should reset to 0 after stopping");
